...
struct Movie:  Identifiable {
    init(id: Int? = nil, title: String? = nil, backdrop_path: String? = nil, release_date: String? = nil, vote_average: String? = nil, overview: String? = nil,  poster_path: String? = nil, spoken_languages: [String]? = nil, cast: [castMember]? = nil, media_type: String? = nil){
        self.id = id ?? 0
        self.title = title ?? ""
